...
class MailController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('mail.create', ['allusers' => $allusers, 'count' => $count, 'layout' => $layout]);
...
//        creat rasevers mail
    ...
    {
//        return $id;
        $mail = MessageReseiver::where('mail_id', $id)
            ->first();
        $mail->update([
            'important' => 1
        ]);
...
//        $mail->delete();
    ...
    public function important()
    {
        ...
        $count = MessageReseiver::where('user_id', $id)->where('status', 0)->count();
        return view('mail.important', ['mails' => $mails,'layout'=>$layout])->with(['count' => $count]);
    }
...
//        return $mail;
        ...
        return view('mail.forward', compact('allusers', 'count', 'mail','layout'));
    }
    ...
    public function download($mailid)
    {
