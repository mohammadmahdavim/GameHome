        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">بوفه</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-row">
                ...
                <div class="p-2">
                    <form action="/report/export/products" method="get">
                        @csrf
            ...
            <div id='search' style="display: none">
                <form method="get" action="/report/products">
                    @csrf
                    <div class="d-flex flex-row">
                        <div class="p-2">
                            ...
                            <select class="js-example-basic-single" name="item_id">
                                ...
                                @foreach($products as $product)
                                    <option @if(request()->item_id==$product->id) selected
