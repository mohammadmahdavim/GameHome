        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ساعتی</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <form action="/planes" method="post">
                            @csrf
                            <input name="type" hidden value="hourly">
                                            ...
                                            <form action="/planes/{{$row->id}}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label> مدت زمان پلن (ساعت)</label>
                                                            <input name="hour" value="{{$row->hour}}" type="number" class="form-control"
                                                                   required>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label> قیمت</label>
                                                            <div class="price-box-product">
                                                                ...
                                                                <input required type="number" value="{{$row->price}}" name="price" id="price"
                                                                       class="form-control">
                                                                <div class="price-box-product-content">
                                                                    <div
                                                                        class="price-box-header-product d-flex justify-content-between align-items-center">
