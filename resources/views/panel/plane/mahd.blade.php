        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">مهد</li>
                </ol>
            </nav>
        </div>
                                            ...
                                            <form action="/planes/{{$row->id}}" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label>تعداد ماه</label>
                                                            <input name="month" value="{{$row->month}}" type="number"
                                                                   class="form-control" required>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label> سقف ساعت</label>
                                                        ...
                                                        <div class="col-md-3">
                                                            <label>شیفت</label>
                                                            <select name="shift" class="form-control">
                                                                <option @if($row->shift=='صبح') selected @endif >صبح
                                                                </option>
                                                                <option @if($row->shift=='عصر') selected @endif >عصر
                                                                </option>
                                                            </select>
                                                        </div>
                                                        {{--                                                        <div class="col-md-1">--}}
                                                        {{--                                                            <label>صبحانه</label>--}}
                                                        {{--                                                            <br>--}}
                                                        {{--                                                            <input name="breakfast" type="checkbox" @if($row->breakfast==1) checked @endif>--}}
                                                        {{--                                                        </div>--}}
                                                        {{--                                                        <div class="col-md-1">--}}
                                                        {{--                                                            <label>ناهار</label>--}}
                                                        {{--                                                            <br>--}}
                                                        {{--                                                            <input name="lunch" type="checkbox" @if($row->lunch==1) checked @endif>--}}
                                                        {{--                                                        </div>--}}
                                                        <div class="col-md-3">
                                                            <label> قیمت</label>
                                                            <div class="price-box-product">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label> سرویس</label>
                                                            <input name="service" value="{{$row->service}}" type="text"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label> قیمت سرویس</label>
                                                            <div class="price-box-product">
                                                                ...
                                                                <input type="number" value="{{$row->service_price}}"
                                                                       name="service_price" id="price"
                                                                       class="form-control">
                                                                <div class="price-box-product-content">
                                                                    <div
                                                                        class="price-box-header-product d-flex justify-content-between align-items-center">
