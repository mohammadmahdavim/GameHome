        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">پیام های مهم</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    @foreach($mails as $mail )
                        ...
                        @if($mail->status != 0)
                            <tr style="" id="tr_{{$mail->id}}">
                        @else
                            <tr class="unread" id="tr_{{$mail->id}}">
                                @endif
                                ...
                                <td class="table-inbox-name">
                                    <a href="<?= url('/mail/showin/' . $mail->mail_id); ?>">
                                        <div class="letter-icon-title text-default">{{ getAuthor(getMyMail($mail->mail_id)->user_id)->name.' '.getAuthor(getMyMail($mail->mail_id)->user_id)->family  }}</div>
                                    </a>
                                </td>
