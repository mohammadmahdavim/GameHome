                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        @foreach( $mails as $mail )
                            ...
                            @if($mail->status == 0)
                                <tr style="background-color: #ec9494">
...
<i class="fa fa-forward"></i>
                                    ...
                                    <td class="table-inbox-name">
                                        <a href="<?= url('/mail/showin/' . $mail->mail_id); ?>">
                                            @if(getAuthor(getMyMail($mail->mail_id)->user_id))
                                                <div
                                                    class="letter-icon-title text-default">{{ getAuthor(getMyMail($mail->mail_id)->user_id)->name.' '.getAuthor(getMyMail($mail->mail_id)->user_id)->family  }}
                                                    @endif
                                                </div>
                                        </a>
                                    </td>
                                    <td class="table-inbox-message">
                                        <span
                                            class="table-inbox-subject">{{ getMyMail($mail->mail_id)->subject  }}</span>
