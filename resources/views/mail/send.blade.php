        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">پیام های ارسالی</li>
                </ol>
            </nav>
        </div>
...
<i class="fa fa-forward"></i>
                                        ...
                                        <a href="<?= url('/mail/showin/' . $mail->mail_id); ?>">
                                            <span
                                                class="btn btn-sm btn-primary btn-rounded icon-undo2 btn-xs">
                                            <i class="fa fa-eye"></i>
                                            </span>
                                        </a>
                                    </td>
                                    ...
                                    <td class="table-inbox-name">
                                        ...
                                        <a href="<?= url('/mail/show/' . $mail->mail_id); ?>">
                                            <div class="letter-icon-title text-default"> {{ \App\Models\User::where('id',$mail->user_id)->first()['name'].' '.\App\Models\User::where('id',$mail->user_id)->first()['family']  }}</div>
                                        </a>
                                    </td>
                                    ...
                                    <td class="table-inbox-attachment">
                                        @if(!empty(checkAttah($mail->mail_id)->filename) != 0)
